...
export const DeltaEventSchema: DefinitionSchema = new DefinitionSchema(
    ...
    [
        {
            name: "CommandSource",
            properties: [PropertyDef({ name: "participationId", type: "ParticipationId" }), PropertyDef({ name: "commandId", type: "CommandId" })],
        },
        PrimitiveDef({ name: "SequenceNumber", primitiveType: "string" }),
        ...
        },
        {
            ...
            properties: [
                // TODO Check type
                PropertyDef({ name: "deletedPartition", type: "LionWebJsonDeltaChunk" }),
                ...ICommonEventProperties,
            ],
            taggedUnionType: "IEvent",
        },
        ...
        },
        {
            ...
            properties: [
                PropertyDef({ name: "parent", type: "LionWebId" }),
                PropertyDef({ name: "deletedChild", type: "LionWebJsonDeltaChunk" }),
                PropertyDef({ name: "containment", type: "LionWebJsonMetaPointer" }),
                PropertyDef({ name: "index", type: "numberString" }),
                ...ICommonEventProperties,
            ],
        ...
        },
        {
            ...
            properties: [
                PropertyDef({ name: "parent", type: "LionWebId" }),
                PropertyDef({ name: "newChild", type: "LionWebJsonDeltaChunk" }),
                PropertyDef({ name: "replacedChild", type: "LionWebJsonDeltaChunk" }),
                PropertyDef({ name: "containment", type: "LionWebJsonMetaPointer" }),
                PropertyDef({ name: "index", type: "numberString" }),
                ...ICommonEventProperties,
            ],
        ...
        },
        {
            ...
            properties: [
                PropertyDef({ name: "parent", type: "LionWebId" }),
                PropertyDef({ name: "index", type: "numberString" }),
                PropertyDef({ name: "deletedAnnotation", type: "LionWebJsonDeltaChunk" }),
                ...ICommonEventProperties,
            ],
            taggedUnionType: "IEvent",
        },
        {
            ...
            properties: [
                PropertyDef({ name: "parent", type: "LionWebId" }),
                PropertyDef({ name: "newAnnotation", type: "LionWebJsonDeltaChunk" }),
                PropertyDef({ name: "replacedAnnotation", type: "LionWebJsonDeltaChunk" }),
                PropertyDef({ name: "index", type: "numberString" }),
                ...ICommonEventProperties,
            ],
            taggedUnionType: "IEvent",
        ...
        {
            name: "CompositeEvent",
            properties: [PropertyDef({ name: "parts", type: "IEvent", isList: true }), EventKindProperty, ProtocolMessageProperty],
        },
        {
            name: "Error",
            properties: [PropertyDef({ name: "errorCode", type: "JS_string" }), PropertyDef({ name: "message", type: "JS_string" }), ...ICommonEventProperties],
            taggedUnionType: "IEvent",
        },
        { name: "NoOpEvent", properties: [...ICommonEventProperties] },
